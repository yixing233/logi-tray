...
| 版本 | 文件 | 内存占用（开窗口） | 适合 |
| --- | --- | --- | --- |
| **完整版** | `logi-tray-v1.1.0.zip`（约 1.6 MB） | 工作集约 141 MB / 提交约 70 MB | 想要亚克力毛玻璃、三种图标样式与主题切换 |
| **轻量版** | `logi-tray-lite-v1.1.0.zip`（约 1.0 MB） | 工作集约 57 MB / 提交约 13 MB | 只要电量数字，希望占用尽可能低 |
